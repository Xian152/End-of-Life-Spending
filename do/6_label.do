...
label variable prosta "suffering from prostate tumor ?"
...
label define hyper 0"no" 1"yes, do not cause inconvience" 2"yes, cause inconvience"
...
foreach k in hexpayer	coresidence	gender	residence	bmiCat	 		occu	bpl	hearingloss	Dcargiv	dril	Dhavedoclic	hexpPayer	ablephyreas	Dplace		marital	smkl	pa {
	label values `k' `k'
}
