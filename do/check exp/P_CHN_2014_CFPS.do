...
Preparation file for China, 2014
	...
	food expense includ cigrate and alchol
...
use "${SOURCE}/WB MICRO DATA/`refid'/Data/ecfps2014famecon_201906.dta", clear
	...
	* Gaul Code
	...
	drop _m 	
save "${TEMP}/CHN_2014_merged.dta",replace
																				// </_import_>

*******************************************************************************************
					***   COMMON VARIABLES   ***
*******************************************************************************************
use "${TEMP}/CHN_2014_merged.dta",clear
local refid "CHN_2014_CFPS"
...
For 
*/
erase "${TEMP}/CHN_2014_merged.dta"
