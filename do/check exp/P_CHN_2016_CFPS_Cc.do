...
*************
	* Total exp aggregates
	gen hh_hexp = fp511 	// oop hexp recall in 12 month
	replace hh_hexp = 0 if inlist(fp511,-1,-2)

	gen hh_hexp_alt =  hexp_OOP // OOP hhexp recall in 12 month from expenditure module
...
* Food / non-food expenditure (annual)												** <_fexp_>
	...
	count if hh_nfexp<0	 // 2509
	drop if hh_nfexp<0 // 2509 hh dropped  
																					// </_fexp_>
* survey variables																	** <_svy_>
	...
	gen hh_urban=urban16==1 if inlist(urban16,0,1) // 250 hh missing 
